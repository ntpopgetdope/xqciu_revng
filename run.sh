...
./scripts/csr.py --inst-dir=${smrnmi_inst_dir} --csr-dir=${smrnmi_csr_dir} --out-c=build/smrnmi_csr.c --out-h=build/smrnmi_csr.h
...
./scripts/decodetree-disas.py --static-decode='decode_smrnmi_32' build/smrnmi-32.decode --insnwidth=32 > build/riscv-smrnmi-32-decode.c.inc
